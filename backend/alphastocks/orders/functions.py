...
from orders.utils import replacement_function
...
from alphastocks.settings import openai_key
...
def selected_assets(trading_client, data_client, start_date, end_date, count=40):
    all_assets = get_all_assets(trading_client)[:count]
